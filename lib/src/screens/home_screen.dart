                      ...
                      children: [
                        FilterChip(
                          ...
                          onSelected: (val) => applicationBloc.togglePlaceType(
                              'barber_shop', val),
                          selected: applicationBloc.placeType == 'barber_shop',
                          selectedColor: Colors.blue,
                        ),
                        FilterChip(
                            label: Text('grocery'),
                            onSelected: (val) => applicationBloc
                                .togglePlaceType('grocery', val),
                            selected: applicationBloc.placeType == 'grocery',
                            selectedColor: Colors.blue),
                        FilterChip(
                            label: Text('Pharmacy'),
                            onSelected: (val) => applicationBloc
                        ...
                        FilterChip(
                            label: Text('Shops'),
                            onSelected: (val) =>
                                applicationBloc.togglePlaceType('Shops', val),
                            selected: applicationBloc.placeType == 'Shops',
                            selectedColor: Colors.blue),
                      ],
                    ),
                  )
